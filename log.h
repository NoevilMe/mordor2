...
/// Log a warning
#define MORDOR_LOG_WARNING(log) MORDOR_LOG_LEVEL(log, ::Mordor::Log::Level::WARNING)
/// Log an informational message
#define MORDOR_LOG_INFO(log) MORDOR_LOG_LEVEL(log, ::Mordor::Log::Level::INFO)
/// Log a verbose message
#define MORDOR_LOG_VERBOSE(log) MORDOR_LOG_LEVEL(log, ::Mordor::Log::Level::VERBOSE)
/// Log a debug message
